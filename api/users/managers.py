...
class UserManager(BaseUserManager):
    def create_user(self, username, password, email, profile_picture, **extra_fields):
        if not username:
        ...
        user = self.model(email=email, username=username, profile_picture=profile_picture)
